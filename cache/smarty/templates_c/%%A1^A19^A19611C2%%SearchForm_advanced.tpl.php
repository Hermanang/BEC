<?php /* Smarty version 2.6.31, created on 2018-09-28 09:33:56
         compiled from cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 27, false),array('function', 'math', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 28, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 34, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 77, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 473, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 554, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Campaigns/SearchForm_advanced.tpl', 92, false),)), $this); ?>
...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_NAME','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
' title=''      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='start_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_START_DATE','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['start_date_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['start_date_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['start_date_advanced_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['start_date_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_start_date_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_start_date_advanced'] ) && ! empty ( $_REQUEST['start_date_advanced'] )): ?><?php echo $_REQUEST['start_date_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_start_date_advanced']; ?>
...
" value='<?php echo $_REQUEST['start_range_start_date_advanced']; ?>
...
" value='<?php echo $_REQUEST['end_range_start_date_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
    <span class="suitepicon suitepicon-module-calendar" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span>
&nbsp;(<span class="dateFormat"><?php echo $this->_tpl_vars['USER_DATEFORMAT']; ?>
</span>)
<script type="text/javascript">
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='end_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_END_DATE','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['end_date_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['end_date_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['end_date_advanced_range_choice']); ?>
<?php else: ?>
<?php $this->assign('starting_choice', "="); ?>
<?php endif; ?>
...
_range_choice" onchange="<?php echo $this->_tpl_vars['id']; ?>
_range_change(this.value);">
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['end_date_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_end_date_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_end_date_advanced'] ) && ! empty ( $_REQUEST['end_date_advanced'] )): ?><?php echo $_REQUEST['end_date_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_end_date_advanced']; ?>
<?php endif; ?>' title=''   size="11" class="dateRangeInput">
    <button id="<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false;" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar"  alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_end_date_advanced']; ?>
' title=''  tabindex='' size="11" class="rangeDateInput">
    <button id="start_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" type="button" onclick="return false" class="btn btn-danger"><span class="suitepicon suitepicon-module-calendar" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span></button>
...
<input autocomplete="off" type="text" name="end_range_<?php echo $this->_tpl_vars['id']; ?>
" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['end_range_end_date_advanced']; ?>
' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
    <span class="suitepicon suitepicon-module-calendar" id="end_range_<?php echo $this->_tpl_vars['id']; ?>
_trigger" alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
"></span>
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_STATUS','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php echo smarty_function_html_options(array('id' => 'status_advanced','name' => 'status_advanced[]','options' => $this->_tpl_vars['fields']['status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['status_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='campaign_type_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN_TYPE','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'campaign_type_advanced','name' => 'campaign_type_advanced[]','options' => $this->_tpl_vars['fields']['campaign_type_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['campaign_type_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Campaigns'), $this);?>
</label>
                            </div>
            <div class="form-item">
